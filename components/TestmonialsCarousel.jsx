...
export default function TestimonialsCarousel(){
    ...
    return (
        <div className='mx-auto p-6 bg-gray-200 text-center'>
            <h2 className='text-5xl inline-block align-middle py-4 sm:text-6xl font-bold text-blue-700'>DEPOIMENTOS</h2>
            <p></p>
